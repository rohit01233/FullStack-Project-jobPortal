    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-200'>
            ...
            <div className='flex items-center gap-2 mt-4'>
                ...
                <Badge variant="ghost" className='text-[#F83002] font-bold'>{job?.salary}</Badge>
                <Badge variant="ghost" className='text-[#7209b7] font-bold'>{job?.jobType}</Badge>
            </div>
